...
--- | --- | --- | ---
[sale_channel](sale_channel/) | 16.0.0.2.0 (unported) |  | Adds the notion of sale channels
[sale_channel_category](sale_channel_category/) | 16.0.1.0.2 (unported) |  | Link Category with sale channel
[sale_channel_partner](sale_channel_partner/) | 16.0.0.0.0 (unported) |  | Bind sale channels to contacts
[sale_channel_product](sale_channel_product/) | 16.0.1.0.1 (unported) |  | Link Product with sale channel
[sale_channel_search_engine](sale_channel_search_engine/) | 16.0.0.1.2 (unported) |  | Abstract module for configuring a search engine on a sale channel
