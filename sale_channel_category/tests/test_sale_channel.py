...
class TestSaleChannel(BaseCommon):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
    ...
    def test_01_root_categ_assignment(self):
        ...
        self.channel_1.write(
            {
                "root_categ_ids": [
                    Command.set([self.root_categ_1.id, self.root_categ_2.id])
                ]
            }
        )
    ...
    def test_02_channel_propagation_to_child_categories(self):
        ...
        self.channel_1.write({"root_categ_ids": [Command.set([self.root_categ_1.id])]})
    ...
    def test_03_multiple_channel_assignment(self):
        ...
        self.channel_1.write({"root_categ_ids": [Command.set([self.root_categ_1.id])]})
        self.channel_2.write({"root_categ_ids": [Command.set([self.root_categ_1.id])]})
    ...
    def test_04_channel_removal(self):
        ...
        # Remove channel
        self.channel_1.write({"root_categ_ids": [Command.clear()]})
    ...
    def test_05_create_channel_with_categories(self):
        ...
        new_channel = self.env["sale.channel"].create(
            {
                "name": "New Channel",
                "root_categ_ids": [Command.set([self.root_categ_1.id])],
            }
        )
